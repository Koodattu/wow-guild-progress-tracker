...
CharacterRaidParticipationSchema.index({ reportGuildId: 1, zoneId: 1, characterName: 1 });
CharacterRaidParticipationSchema.index({ characterRealm: 1, characterName: 1 });
CharacterRaidParticipationSchema.index({ wclCanonicalCharacterId: 1, zoneId: 1, reportGuildId: 1 }, { unique: true });
